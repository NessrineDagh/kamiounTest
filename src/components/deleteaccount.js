...
export default function DeleteAccount() {
    ...
    return (
        <div className='bg-white px-10 py-10 rounded-3xl border-2 border-gray-200 shadow-2xl'>
            <h1 className='text-center text-xl font-semibold text-blue-500 mt-4 mb-4'>Delete Your Account</h1>
            <p>We're sorry to see you go. It would be great if we could know the reason behind.</p>
            <form onSubmit={handleSubmit}>
                <div>
                    <div class="flex">
                        <svg class="h-15 w-5 mr-2 text-white fill-red-600" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                        </svg>
                        <p className='text-red-600 mt-4 mb-4'>Please select one of the below reasons.</p>
                    </div>
                ...
                <div>
                    ...
                    ></textarea>
                    <p className='font-extralight text-right text-gray-400'>Max. 2000 characters</p>
                </div>
                <div className='mt-8'>
                    <button 
                        type="submit" 
